...
function Login() {
  ...
  <img src="/queued.png" alt="Queued" className="h-12 object-contain" />
</div>

        {/* Card */}
        <div className="bg-[#1a1815] border border-white/7 rounded-2xl p-10">
          <h1 className="text-xl font-medium text-[#f0ede8] mb-1 text-center">
            Welcome back
          </h1>
          <p className="text-[13px] text-[#9a9590] mb-8 text-center">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            <div>
             <label className="text-[11px] text-[#9a9590] mb-1.5 ml-2 block cursor-pointer">Email</label>
              <input
                type="email"
                value={email}
            ...
            <div>
              <label className="text-[11px] text-[#9a9590] mb-1.5 ml-2 block cursor-pointer">Password</label>
              <input
                type="password"
                value={password}
  ...
  type="submit"
  disabled={loading}
  className="w-full text-white font-medium py-3 rounded-full text-sm hover:opacity-90 disabled:opacity-50 mt-4 cursor-pointer transition-all"
...
>
          ...
          <p className="text-[12px] text-[#9a9590] text-center mt-6">
            ...
            <Link
              to="/register"
              className="text-[#D13924] hover:underline cursor-pointer"
            >
              Create one
            </Link>
          </p>
