...
function Schedule() {
  ...
  const baseShows =
    activeTab === "mySchedule" ? shows.filter((s) => s.onMyList) : shows;
    ...
    <div className="bg-[#0f0e0d] min-h-screen text-white">
      ...
      <div className="px-6 py-8 max-w-6xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-xl font-medium text-[#f0ede8] mb-1">
              Schedule
            </h1>
            <p className="text-[13px] text-[#9a9590]">
              Spring 2026 · Updated daily from all major platforms
            </p>
          </div>
        ...
        <div className="flex gap-1 bg-[#1a1815] border border-white/7 rounded-xl p-1 w-fit mb-6">
          {isLoggedIn && (
            <button
              ...
              style={
                activeTab === "mySchedule" ? { backgroundColor: "#D13924" } : {}
              }
            >
              My Schedule
            </button>
          ...
          <button
            ...
            style={
              activeTab === "fullSchedule" ? { backgroundColor: "#D13924" } : {}
            }
          >
            Full Schedule
          </button>
              ...
              {showsForDay.map((show) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="text-[13px] font-medium text-[#f0ede8] truncate mb-1">
                      {show.title}
                    </div>
                  ...
                  <div className="flex gap-1.5 flex-shrink-0">
                    <span className="text-[9px] text-[#1D9E75] bg-[#1D9E75]/10 border border-[#1D9E75]/25 px-2 py-0.5 rounded">
                      SUB
                    </span>
                  </div>
        ...
        <div>
          <div className="flex items-center gap-3 mb-4">
            <h2 className="text-sm font-medium text-[#f0ede8]">
              {activeTab === "mySchedule"
                ? "All shows on my list"
                : "Full season — Spring 2026"}
            </h2>
            <div className="flex-1 h-px bg-white/5" />
            <span className="text-[11px] text-[#9a9590]">
          ...
          <div className="grid grid-cols-4 gap-4">
            {filteredShows.map((show) => (
              ...
              >
                ...
                <div className="p-3">
                  <div className="text-[12px] font-medium text-[#f0ede8] truncate mb-1">
                    {show.title}
                  </div>
                  <div className="text-[10px] text-[#9a9590] truncate mb-2">
                    {show.genres.slice(0, 2).join(" · ")}
                  </div>
                  ...
                  <div className="flex gap-1">
                    <span className="text-[8px] text-[#1D9E75] bg-[#1D9E75]/10 border border-[#1D9E75]/25 px-1.5 py-0.5 rounded">
                      SUB
                    </span>
                  </div>
                </div>
